...
const VoltageControl = ({ data, endpoint }) => {
  return (
    <View className="flex flex-col">
      ...
      <View className="flex flex-col">
        <VoltageInput ac={true} disconnect={true} voltage={data.acChargeStopVoltage} endpoint={endpoint}/>
        <View className="my-1 border-b border-slate-700"></View>
        <VoltageInput ac={true} disconnect={false} voltage={data.acChargeStartVoltage} endpoint={endpoint}/>
      </View>
