...
export function nativeResolver(resolver, context, moduleName, platform) {
  ...
  const isReactNativeIndex = context.originModulePath.endsWith(`react-native${sep}index.js`);
  ...
  } else if (resolution.filePath.includes(`${sep}react-native${sep}Libraries${sep}`)) {
